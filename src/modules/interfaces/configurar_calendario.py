...
class ConfigurarCalendarioWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # Información de uso
        info_label = QLabel(
            "Haz clic en fechas del calendario para añadir días • Arrastra días entre columnas para cambiar horarios")
    ...
    def aplicar_nuevo_anio(self) -> None:
        ...
        try:
            ...
            # Log del cambio
            self.log_mensaje(f"Año académico cambiado a {nuevo_anio}-{nuevo_anio + 1}", "success")
    ...
    def actualizar_contadores(self) -> None:
        ...
        def contar_por_horario(semestre_data):
            """ Cuenta los días configurados por cada horario """
    ...
    def verificar_y_restaurar_numeracion(self, grid_layout) -> None:
        ...
        try:
            ...
            self.log_mensaje(f"Error restaurando numeración: {e}", "warning")
    ...
    def cargar_dias_en_grids(self) -> None:
        ...
        try:
            ...
            self.log_mensaje(f"Error cargando días en grids: {e}", "warning")
    ...
    def eliminar_dia(self, fecha, semestre) -> None:
        ...
        try:
            if fecha in self.datos_configuracion[semestre]:
                ...
                self.log_mensaje(f"Día {fecha} eliminado", "info")

        except Exception as e:
            self.log_mensaje(f"Error eliminando día: {e}", "warning")
